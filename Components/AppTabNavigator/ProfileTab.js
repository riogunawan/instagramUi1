...
import { Container, Content, Icon, Button, Header, Left, Right, Body } from "native-base"
...
var images = [
	...
	require('../../assets/feed_images/10.png'),
	require('../../assets/feed_images/11.jpg'),
	require('../../assets/feed_images/12.png'),
]
		...
		if (this.state.activeIndex == 0) {
			...
			return (
				<View>
					...
					<CardComponent imageSource="3" likes="151" />
				</View>
			)
        ...
        return (
			<Container style={styles.container} >
				...
				<Header style={ styles.androidHeader }>
					...
					<Body><Text>ja_riogunawan</Text></Body>
				...
				<Content>
					<View style={{ paddingTop: 10 }}>
						...
						<View style={{ paddingVertical: 10, paddingHorizontal: 10 }} >
							<Text style={{ fontWeight: 'bold' }}>Rio Gunawan </Text>
							<Text>Programer | dll | mantap</Text>
